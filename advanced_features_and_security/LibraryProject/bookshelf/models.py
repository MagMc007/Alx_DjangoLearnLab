...
class Book(models.Model):
    ...
    def __str__(self):
        return f"Title: {self.title} by {self.author} publsihed in {self.publication_year}"
...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, full_name, password=None,**extrafields):
